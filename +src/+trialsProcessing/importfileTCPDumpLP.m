function output = importfileTCPDumpLP(filename, startRow, endRow)
%importfileTCPDumpLP Import numeric data from a text file as a matrix.
%   output = importfileTCPDumpLP(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   output = importfileTCPDumpLP(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   output = importfile('DH_tcpDump_LP.log', 1, 88847);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/03/16 00:15:48
